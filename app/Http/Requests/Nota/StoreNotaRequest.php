...
class StoreNotaRequest extends FormRequest
{
    ...
    {
        return true; // Controle de acesso feito no middleware de perfil
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'itens.*.quantidade.numeric'     => 'A quantidade do item :position deve ser um número.',
            ...
            'itens.*.valor.numeric'          => 'O valor do item :position deve ser um número.',
